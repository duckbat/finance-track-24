...
const SideNavBar = () => {
  ...
  // Add routes and links to navigate to different pages and change it to "Layout.tsx"
  return (
    <>
      <button
        ...
        <div className="h-full overflow-y-auto bg-gray-50 px-3 py-4 dark:bg-gray-800">
          <ul className="space-y-2 font-medium">
            <li>
              <Link
                to="/upload"
                className="dark:hover:bg-gray-7 00 group flex items-center rounded-lg bg-gray-200 p-2 text-gray-900 hover:bg-gray-300 dark:bg-gray-900 dark:text-white"
              >
                <svg
            ...
            <li>
              <Link
                to="/about" //Link to profile and own spending
                className="group flex items-center rounded-lg p-2 text-gray-900 hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
              >
                <svg
                  className="h-5 w-5 flex-shrink-0 text-gray-500 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white"
            ...
            <li>
              ...
              >
                ...
                <span className="ms-3 flex-1 whitespace-nowrap">Log In</span>
              </Link>
            </li>
            <li>
              <Link
              ...
              >
                ...
                <span className="ms-3 flex-1 whitespace-nowrap">Register</span>
              </Link>
            </li>
            <li>
              <Link
