...
const useTransaction = () => {
  ...
  const postMedia = async (
    ...
    // the type is MediaItem without transaction_id, user_id,
  ...
  const deleteMedia = async (transaction_id: string, token: string) => {
  ...
  return {transactionArray, postMedia, deleteMedia};
};
